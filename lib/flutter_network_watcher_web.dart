// This file must import flutter_web_plugins for Flutter web plugin
// registration, which requires using web libraries.
...
class FlutterNetworkWatcherPlugin {
  ...
  /// Returns the platform name for this plugin
